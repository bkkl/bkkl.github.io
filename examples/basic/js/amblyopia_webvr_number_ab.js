...
/*     var abc = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";p
	...
	loader.load('fonts/helvetiker_bold.typeface.json', function ( font ) {
		...
		Tetris.text_1 = new THREE.Mesh( textGeo, textMaterial );
		...
		Tetris.text_1.position.x = -middle.x;
		Tetris.text_1.position.y = -middle.y;
		Tetris.text_1.position.z = z_start;
		Tetris.text_1.castShadow = false;
		Tetris.text_1.receiveShadow = false;	
		...
		Tetris.text_2 = new THREE.Mesh( textGeo, textMaterial );
		// find middle of font
		var middle = new THREE.Vector3();
		...
		Tetris.text_2.position.x = -middle.x;
		Tetris.text_2.position.y = -middle.y;
		Tetris.text_2.position.z = z_start;
		Tetris.text_2.castShadow = false;
		Tetris.text_2.receiveShadow = false;	
		...
		Tetris.text_3 = new THREE.Mesh( textGeo, textMaterial );
		// find middle of font
		var middle = new THREE.Vector3();
		...
		Tetris.text_3.position.x = -middle.x;
		Tetris.text_3.position.y = -middle.y;
		Tetris.text_3.position.z = z_start;
		Tetris.text_3.castShadow = false;
		Tetris.text_3.receiveShadow = false;	
		...
		Tetris.text_4 = new THREE.Mesh( textGeo, textMaterial );
		// find middle of font
		var middle = new THREE.Vector3();
		...
		Tetris.text_4.position.x = -middle.x;
		Tetris.text_4.position.y = -middle.y;
		Tetris.text_4.position.z = z_start;
		Tetris.text_4.castShadow = false;
		Tetris.text_4.receiveShadow = false;	
		...
		Tetris.text_5 = new THREE.Mesh( textGeo, textMaterial );
		// find middle of font
		var middle = new THREE.Vector3();
		...
		Tetris.text_5.position.x = -middle.x;
		Tetris.text_5.position.y = -middle.y;
		Tetris.text_5.position.z = z_start;
		Tetris.text_5.castShadow = false;
		Tetris.text_5.receiveShadow = false;	
		...
		Tetris.text_6 = new THREE.Mesh( textGeo, textMaterial );
		// find middle of font
		var middle = new THREE.Vector3();
		...
		Tetris.text_6.position.x = -middle.x;
		Tetris.text_6.position.y = -middle.y;
		Tetris.text_6.position.z = z_start;
		Tetris.text_6.castShadow = false;
		Tetris.text_6.receiveShadow = false;	
		...
		Tetris.text_7 = new THREE.Mesh( textGeo, textMaterial );
		// find middle of font
		var middle = new THREE.Vector3();
		...
		Tetris.text_7.position.x = -middle.x;
		Tetris.text_7.position.y = -middle.y;
		Tetris.text_7.position.z = z_start;
		Tetris.text_7.castShadow = false;
		Tetris.text_7.receiveShadow = false;	
		...
		Tetris.text_8 = new THREE.Mesh( textGeo, textMaterial );
		// find middle of font
		var middle = new THREE.Vector3();
		...
		Tetris.text_8.position.x = -middle.x;
		Tetris.text_8.position.y = -middle.y;
		Tetris.text_8.position.z = z_start;
		Tetris.text_8.castShadow = false;
		Tetris.text_8.receiveShadow = false;	
		...
		Tetris.text_9 = new THREE.Mesh( textGeo, textMaterial );
		// find middle of font
		var middle = new THREE.Vector3();
		...
		Tetris.text_9.position.x = -middle.x;
		Tetris.text_9.position.y = -middle.y;
		Tetris.text_9.position.z = z_start;
		Tetris.text_9.castShadow = false;
		Tetris.text_9.receiveShadow = false;	
		...
		Tetris.text_0 = new THREE.Mesh( textGeo, textMaterial );
		// find middle of font
		var middle = new THREE.Vector3();
		...
		Tetris.text_0.position.x = -middle.x;
		Tetris.text_0.position.y = -middle.y;
		Tetris.text_0.position.z = z_start;
		Tetris.text_0.castShadow = false;
		Tetris.text_0.receiveShadow = false;			
	...
	//  read this 
		...
		//1
		var textGeo = new THREE.TextGeometry("ONE", {
			font: font,
		...
		textGeo.computeBoundingBox();
		Tetris.text_key_1 = new THREE.Mesh( textGeo, textMaterial );
		// find middle of font
		var middle = new THREE.Vector3();
		...
		Tetris.text_key_1.position.x = -middle.x;
		Tetris.text_key_1.position.y = -middle.y;
		Tetris.text_key_1.position.z = z_start;
		Tetris.text_key_1.castShadow = false;
		Tetris.text_key_1.receiveShadow = false;	
			//2
		var textGeo = new THREE.TextGeometry("TWO", {
			font: font,
			size: font_size_key, // font size
			height: 20, // how much extrusion (how thick / deep are the letters)
			curveSegments: 12,
		...
		textGeo.computeBoundingBox();
		Tetris.text_key_2 = new THREE.Mesh( textGeo, textMaterial );
		// find middle of font
		var middle = new THREE.Vector3();
		...
		Tetris.text_key_2.position.x = -middle.x;
		Tetris.text_key_2.position.y = -middle.y;
		Tetris.text_key_2.position.z = z_start;
		Tetris.text_key_2.castShadow = false;
		Tetris.text_key_2.receiveShadow = false;	
			//3
		var textGeo = new THREE.TextGeometry("THREE", {
			font: font,
			size: font_size_key, // font size
			height: 20, // how much extrusion (how thick / deep are the letters)
			curveSegments: 12,
		...
		textGeo.computeBoundingBox();
		Tetris.text_key_3 = new THREE.Mesh( textGeo, textMaterial );
		// find middle of font
		var middle = new THREE.Vector3();
		...
		Tetris.text_key_3.position.x = -middle.x;
		Tetris.text_key_3.position.y = -middle.y;
		Tetris.text_key_3.position.z = z_start;
		Tetris.text_key_3.castShadow = false;
		Tetris.text_key_3.receiveShadow = false;	
			//4
		var textGeo = new THREE.TextGeometry("FOUR", {
			font: font,
			size: font_size_key, // font size
			height: 20, // how much extrusion (how thick / deep are the letters)
			curveSegments: 12,
		...
		textGeo.computeBoundingBox();
		Tetris.text_key_4 = new THREE.Mesh( textGeo, textMaterial );
		// find middle of font
		var middle = new THREE.Vector3();
		...
		Tetris.text_key_4.position.x = -middle.x;
		Tetris.text_key_4.position.y = -middle.y;
		Tetris.text_key_4.position.z = z_start;
		Tetris.text_key_4.castShadow = false;
		Tetris.text_key_4.receiveShadow = false;	
			//5
		var textGeo = new THREE.TextGeometry("FIVE", {
			font: font,
			size: font_size_key, // font size
			height: 20, // how much extrusion (how thick / deep are the letters)
			curveSegments: 12,
		...
		textGeo.computeBoundingBox();
		Tetris.text_key_5 = new THREE.Mesh( textGeo, textMaterial );
		// find middle of font
		var middle = new THREE.Vector3();
		...
		Tetris.text_key_5.position.x = -middle.x;
		Tetris.text_key_5.position.y = -middle.y;
		Tetris.text_key_5.position.z = z_start;
		Tetris.text_key_5.castShadow = false;
		Tetris.text_key_5.receiveShadow = false;	
			//6
		var textGeo = new THREE.TextGeometry("SIX", {
			font: font,
			size: font_size_key, // font size
			height: 20, // how much extrusion (how thick / deep are the letters)
			curveSegments: 12,
		...
		textGeo.computeBoundingBox();
		Tetris.text_key_6 = new THREE.Mesh( textGeo, textMaterial );
		// find middle of font
		var middle = new THREE.Vector3();
		...
		Tetris.text_key_6.position.x = -middle.x;
		Tetris.text_key_6.position.y = -middle.y;
		Tetris.text_key_6.position.z = z_start;
		Tetris.text_key_6.castShadow = false;
		Tetris.text_key_6.receiveShadow = false;	
			//7
		var textGeo = new THREE.TextGeometry("SEVEN", {
			font: font,
			size: font_size_key, // font size
			height: 20, // how much extrusion (how thick / deep are the letters)
			curveSegments: 12,
		...
		textGeo.computeBoundingBox();
		Tetris.text_key_7 = new THREE.Mesh( textGeo, textMaterial );
		// find middle of font
		var middle = new THREE.Vector3();
		...
		Tetris.text_key_7.position.x = -middle.x;
		Tetris.text_key_7.position.y = -middle.y;
		Tetris.text_key_7.position.z = z_start;
		Tetris.text_key_7.castShadow = false;
		Tetris.text_key_7.receiveShadow = false;	
			//8
		var textGeo = new THREE.TextGeometry("EIGHT", {
			font: font,
			size: font_size_key, // font size
			height: 20, // how much extrusion (how thick / deep are the letters)
			curveSegments: 12,
		...
		textGeo.computeBoundingBox();
		Tetris.text_key_8 = new THREE.Mesh( textGeo, textMaterial );
		// find middle of font
		var middle = new THREE.Vector3();
		...
		Tetris.text_key_8.position.x = -middle.x;
		Tetris.text_key_8.position.y = -middle.y;
		Tetris.text_key_8.position.z = z_start;
		Tetris.text_key_8.castShadow = false;
		Tetris.text_key_8.receiveShadow = false;	
			//9
		var textGeo = new THREE.TextGeometry("NINE", {
			font: font,
			size: font_size_key, // font size
			height: 20, // how much extrusion (how thick / deep are the letters)
			curveSegments: 12,
		...
		textGeo.computeBoundingBox();
		Tetris.text_key_9 = new THREE.Mesh( textGeo, textMaterial );
		// find middle of font
		var middle = new THREE.Vector3();
		...
		Tetris.text_key_9.position.x = -middle.x;
		Tetris.text_key_9.position.y = -middle.y;
		Tetris.text_key_9.position.z = z_start;
		Tetris.text_key_9.castShadow = false;
		Tetris.text_key_9.receiveShadow = false;	
    //0
		var textGeo = new THREE.TextGeometry("0", {
			font: font,
			size: font_size_key, // font size
		...
		textGeo.computeBoundingBox();
		Tetris.text_key_0 = new THREE.Mesh( textGeo, textMaterial );
		// find middle of font
		var middle = new THREE.Vector3();
		...
		Tetris.text_key_0.position.x = -middle.x;
		Tetris.text_key_0.position.y = -middle.y;
		Tetris.text_key_0.position.z = z_start;
		Tetris.text_key_0.castShadow = false;
		Tetris.text_key_0.receiveShadow = false;		
	//A
		var textGeo = new THREE.TextGeometry("A", {
			font: font,
			size: font_size_key, // font size
...
function rand_num() {
	var rand = Math.floor(Math.random() * (lorn-1+1))+1;
	return  rand;
}
...
function rand_set_key (rand_key_value) {
		switch (rand_key_value) {
			// numbers first 
			case 1:
				Tetris.text_key = Tetris.text_key_1;
				break;
			case 2: 
				Tetris.text_key = Tetris.text_key_2;
				break;
			case 3: 
				Tetris.text_key = Tetris.text_key_3;
				break;
			case 4: 
				Tetris.text_key = Tetris.text_key_4;
				break;	
			case 5:
				Tetris.text_key = Tetris.text_key_5;
				break;
			case 6: 
				Tetris.text_key = Tetris.text_key_6;
				break;
			case 7: 
				Tetris.text_key = Tetris.text_key_7;
				break;
			case 8: 
				Tetris.text_key = Tetris.text_key_8;
				break;			
			case 9: 
				Tetris.text_key = Tetris.text_key_9;
				break;
			// bkl should be 0, but using 9 again to not confuse the player with "O"	
			case 10: 
				Tetris.text_key = Tetris.text_key_9;
				break;
...
function rand_set_active (rand_key_value) {
		switch (rand_key_value) {
			// numbers first
			case 1:
				Tetris.text_active = Tetris.text_1;
				break;
			case 2: 
				Tetris.text_active = Tetris.text_2;
				break;
			case 3: 
				Tetris.text_active = Tetris.text_3;
				break;
			case 4: 
				Tetris.text_active = Tetris.text_4;
				break;	
			case 5:
				Tetris.text_active = Tetris.text_5;
				break;
			case 6: 
				Tetris.text_active = Tetris.text_6;
				break;
			case 7: 
				Tetris.text_active = Tetris.text_7;
				break;
			case 8: 
				Tetris.text_active = Tetris.text_8;
				break;			
			case 9: 
				Tetris.text_active = Tetris.text_9;
				break;
			// bkl should be 0, but using 9 again to not confuse the player with "O"	
			case 10: 
				Tetris.text_active = Tetris.text_9;
